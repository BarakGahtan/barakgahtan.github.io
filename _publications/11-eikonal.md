...
venue: "Symposium on Geometry Processing (SGP 2026)"
...
Accepted to the [Symposium on Geometry Processing (SGP 2026)](https://sgp26.org/). The paper will appear in the [Eurographics Digital Library SGP collection](https://diglib.eg.org/handle/10.2312/434).
